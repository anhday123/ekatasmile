...
import { ArrowLeftOutlined, AudioOutlined, UserOutlined } from "@ant-design/icons";
const { Option } = Select;
      ...
      >
        ...
        <div style={{ display: 'flex', backgroundColor: 'white', padding: '1rem', borderRadius: '0.5rem', justifyContent: 'flex-start', marginTop: '1rem', alignItems: 'center', flexDirection: 'column', width: '100%' }}>
          ...
          <Row style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%' }}>
            <Col style={{ width: '100%', marginTop: '1rem' }} xs={24} sm={12} md={12} lg={12} xl={12}>
              <div style={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center', width: '100%' }}>
                <div style={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center', marginRight: '0.5rem' }}>
                  <div style={{ backgroundColor: 'black', borderRadius: '50%', padding: '0.25rem' }}><UserOutlined style={{ color: 'white', fontSize: '1.25rem' }} /></div>
                </div>
                <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'center', width: '100%' }}>
                  <div style={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center', width: '100%' }}>Văn Tỷ</div>
                  <div style={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center', width: '100%' }}>0384943497</div>
                </div>
              </div>
            </Col>
            <Col style={{ width: '100%' }} xs={24} sm={12} md={12} lg={12} xl={12}>
              <div style={{ display: 'flex', justifyContent: 'flex-end', alignItems: 'center', width: '100%' }}>Công nợ hiện tại: 4.000.000 VNĐ</div>
            </Col>
          </Row>
        </div>
            ...
            <Col style={{ width: '100%', marginTop: '1rem' }} xs={24} sm={24} md={11} lg={11} xl={5}>
              <div style={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center', width: '100%', flexDirection: 'column' }}>
                ...
                <Form.Item
                  ...
                  rules={[{ required: true, message: 'Giá trị rỗng!' }]}
                >
                  <Select disabled defaultValue="employee1" style={{ width: '100%' }}>
        ...
        <div style={{ display: 'flex', backgroundColor: 'white', padding: '1rem', borderRadius: '0.5rem', justifyContent: 'flex-start', marginTop: '1rem', alignItems: 'center', flexDirection: 'column', width: '100%' }}>
          <div style={{ display: 'flex', justifyContent: 'flex-start', color: 'black', fontWeight: '600', width: '100%' }}>Thông tin vận đơn</div>
