import { Drawer, Button, Form, Input, Col, Row, InputNumber, Select } from 'antd'
const { Option } = Select
export default function UpdateProductSingle(props) {
    const { arrayUpdate, category, supplier, warranty, UploadImg, styles, UploadImgChild } = props
    ...
    return (
        <Drawer
            ...
            footer={
                ...
                >
                    <Button
                        onClick={() => props.onCloseUpdateFunc(1)}
                        type="primary"
                    >
                        Cập nhật
                    </Button>
              ...
              > */}
                    ...
                    > */}
                                    ...
                                    if (data === 'suppliers') {
                                        const InputName = () => (
                                            <Select
                                                defaultValue={values.suppliers.supplier_id}
                                                showSearch
                                                style={{ width: '100%' }}
                                                placeholder="Chọn nhà cung cấp"
                                                optionFilterProp="children"
