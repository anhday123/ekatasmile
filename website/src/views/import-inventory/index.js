          ...
          <Col span={8}>
            <Form layout="vertical" form={formInfoOrder}>
              <div className={styles['block']} style={{ marginBottom: 30 }}>
                ...
                <Form.Item label="Chính sách giá" name="">
                  <Select defaultValue="Giá bán lẻ" style={{ width: '100%' }}>
                    <Select.Option value="Giá bán lẻ">Giá bán lẻ</Select.Option>
                    <Select.Option value="Giá buôn">Giá buôn</Select.Option>
                  </Select>
                </Form.Item>

                <Form.Item label="Hẹn ngày giao" name="">
                  <DatePicker
                ...
                <Form.Item label="Đường dẫn đơn hàng trên kênh" name="">
                  <Input placeholder="https://" />
                </Form.Item>

                <Form.Item label="Nhân viên" name="">
                  <Input
                ...
                <Form.Item label="Tham chiếu" name="">
                  <Input placeholder="" />
                </Form.Item>
              </div>
