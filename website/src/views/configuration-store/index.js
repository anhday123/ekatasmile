...
import { ShopOutlined, FileExcelOutlined, FormOutlined, DollarOutlined, TeamOutlined, CreditCardOutlined, ApartmentOutlined, BranchesOutlined } from "@ant-design/icons";
    ...
    <>
      <div className={styles['configuration']}>
        ...
        <div className={styles['configuration_content']}>
          ...
          <Row style={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center', width: '100%' }}>
            <Col style={{ width: '100%', marginTop: '1rem', marginRight: '1rem' }} xs={24} sm={24} md={11} lg={7} xl={7}>
              <Link to={ROUTES.BRANCH} style={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center', width: '100%' }}>
            ...
            <Col style={{ width: '100%', marginTop: '1rem', marginRight: '1rem' }} xs={24} sm={24} md={11} lg={7} xl={7}>
              <Link to={ROUTES.STORE} style={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center', width: '100%' }}>
            ...
            <Col style={{ width: '100%', marginTop: '1rem', marginRight: '1rem' }} xs={24} sm={24} md={11} lg={7} xl={7}>
              <Link to={ROUTES.USER} style={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center', width: '100%' }}>
            ...
            <Col style={{ width: '100%', marginTop: '1rem', marginRight: '1rem' }} xs={24} sm={24} md={11} lg={7} xl={7}>
              <Link to={ROUTES.EMPLOYEE} style={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center', width: '100%' }}>
        ...
        <div className={styles['configuration_content']}>
          ...
          <Row style={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center', width: '100%' }}>
            <Col style={{ width: '100%', marginTop: '1rem', marginRight: '1rem' }} xs={24} sm={24} md={11} lg={7} xl={7}>
              <Link to={ROUTES.TAX} style={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center', width: '100%' }}>
            ...
            <Col style={{ width: '100%', marginTop: '1rem', marginRight: '1rem' }} xs={24} sm={24} md={11} lg={7} xl={7}>
              <Link to={ROUTES.PAYMENT} style={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center', width: '100%' }}>
        ...
        <div className={styles['configuration_content']}>
          ...
          <Row style={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center', width: '100%' }}>
            ...
            <Col style={{ width: '100%', marginTop: '1rem', marginRight: '1rem' }} xs={24} sm={11} md={11} lg={7} xl={7}>
              <Link to={ROUTES.ACTIVITY_DIARY} style={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center', width: '100%' }}>
