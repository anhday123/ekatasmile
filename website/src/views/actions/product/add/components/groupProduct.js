...
export default function GroupProduct(props) {
  ...
  const openNotificationDynamic = () => {
    notification.warning({
      message: 'Nhắc nhở',
      description: `Tối đa chỉ tạo 2 variant.`,
    })
  }
  ...
  const openNotificationDynamicWarn = () => {
    notification.warning({
      message: 'Nhắc nhở',
      description: `Bạn phải nhập tên sản phẩm, sku và chọn nhà cung cấp trước.`,
    })
  }
  ...
  const openNotificationErrorGroupDynamic = (data) => {
    if (data === 1) {
      ...
      notification.error({
        message: 'Thất bại',
        description:
          'Tất cả giá nhập, số lượng nhà cung cấp phải lớn hơn 0. (preview).',
      })
    } else if (data === 3) {
      notification.error({
        message: 'Thất bại',
      ...
      notification.error({
        message: 'Thất bại',
        description:
          'Tất cả giá nhập và số lượng nhà cung cấp phải lớn hơn 0. (preview).',
      })
    } else if (data === 10) {
      notification.error({
        message: 'Thất bại',
  ...
  const onClickAddProductGroup = () => {
    if (
      ...
      options &&
        options.length > 0 &&
        options.forEach((values1, index1) => {
          ...
          if (index1 === 0) {
            values1 &&
              values1.array &&
              values1.array.forEach((values2, index2) => {
                if (category === '') {
                  count++
                  count5++
                }
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <b style={{ color: 'red', marginRight: '0.25rem' }}>*</b>Tên sản
              phẩm
            </div>
          ...
          >
            ...
            >
              <b style={{ color: 'red', marginRight: '0.25rem' }}>*</b>SKU
            </div>
            <Input
              value={sku}
              name="sku"
          ...
          >
            ...
            >
              <b style={{ color: 'red', marginRight: '0.25rem' }}>*</b>Nhà cung
              cấp
            </div>
            <Select
              value={supplierGroup}
          ...
          >
            ...
            >
              <b style={{ color: 'red', marginRight: '0.25rem' }}>*</b>Nhà Kho
            </div>
            <Select
              value={warehouse}
          ...
          >
            ...
            >
              <b style={{ color: 'red', marginRight: '0.25rem' }}>*</b>Loại sản
              phẩm
            </div>
            <Select
              // className={
        ...
        {sku && productName && supplierGroup && supplierGroup.length > 0 ? (
          <div className={styles['variant']}>
            ...
            >
              ...
              <Col
                ...
                lg={12}
                xl={12}
                className={styles['variant_title']}
              >
                <div
                ...
                if (index > 0) {
                  return (
                    ...
                    >
                        ...
                        >
                          ...
                          >
                            <Input
                              value={values.name}
                              name="name"
                              onChange={(e) => onChangeOptions(e, index)}
                        ...
                        >
                          ...
                          >
                            <Select
                              value={values.values}
                              onChange={(e) =>
                                handleChangeSelectOptions(e, index)
                              }
                              mode="tags"
                              style={{ width: '100%' }}
                      ...
                      >
                        <CloseOutlined
                          onClick={() => onClickDeleteOptions(index)}
                          style={{
                            fontSize: '1.5rem',
                            paddingTop: '2rem',
                            cursor: 'pointer',
        ...
        supplierGroup.length > 0 ? (
          <div className={styles['preview']}>
            ...
            {options &&
              options.length > 0 &&
              options[0].array.map((values2, index) => {
                return (
                  <Row
                    style={{
                      display: 'flex',
                  ...
                  >
                    ...
                    >
                      <div
                        className={
                          styles['product_manager_content_image_child']
                        }
                      >
                        <Dragger
                          name="file"
                          ...
                          style={{ width: '7.5rem' }}
                          onChange={(event) => onChangeGroup(event, index)}
                        >
                          {values2 && values2.image.length > 0 ? (
                            <p
                              style={{ marginTop: '1.25rem' }}
                              className="ant-upload-drag-icon"
                            >
                              <img
                                src={values2.image[values2.image.length - 1]}
                                style={{
                                  width: '5rem',
                                  height: '2.5rem',
                                  objectFit: 'contain',
                            ...
                            <p
                              style={{ marginTop: '1.25rem', width: '7.5rem' }}
                              className="ant-upload-drag-icon"
                            >
                              <PlusOutlined />
                        ...
                        >
                          {values2 &&
                            values2.image.length > 0 &&
                            values2.image.map((values, index) => {
                              return (
                                <img
                                  src={values}
                                  style={{
                      ...
                      >
                        ...
                        >
                          <Input
                            ...
                            value={values2.sku}
                            name="sku"
                            onChange={(e) => onChangeSkuMain(e, index)}
                          />
                        </div>
                      </div>
                    </Col>
                    ...
                    >
                      <div style={{ marginBottom: '1rem' }}>
                        ...
                        <InputNumber
                          ...
                          defaultValue={0}
                          onChange={(e) =>
                            onChangeSupplierQuantity(e, index, index)
                          }
                        />
                      </div>
                    </Col>
        ...
        >
          ...
          <div>
            <Button
              onClick={onClickAddProductGroup}
              htmlType="submit"
              size="large"
              type="primary"
            >
