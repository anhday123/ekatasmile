    ...
    <>
      <div className={styles["supplier_add"]}>
        <Link className={styles["supplier_add_back_parent"]} style={{ borderBottom: '1px solid rgb(233, 220, 220)', paddingBottom: '1rem' }} to="/actions/shipping-product/add/9">
          ...
          <div className={styles["supplier_add_back"]}>Phiếu chuyển hàng DNB001</div>
        ...
        >
            ...
            <Col style={{ width: '100%' }} xs={24} sm={24} md={24} lg={12} xl={12}>
              <Row style={{ display: 'flex', alignItems: 'center', justifyContent: 'flex-start', width: '100%' }}>
                ...
                <Col style={{ width: '100%', paddingBottom: '0.5rem', display: 'flex', justifyContent: 'flex-start' }} xs={24} sm={24} md={24} lg={11} xl={11}>
                  <div style={{ width: '7.5rem ', display: 'flex', justifyContent: 'center', backgroundColor: '#FFAC2F', color: 'black', padding: '0.25rem 1rem', borderRadius: '2rem' }}>Chờ chuyển</div>
                </Col>
              </Row>
            </Col>
          </Row>
          ...
          <Row style={{ display: 'flex', marginBottom: '0.5rem', justifyContent: 'space-between', alignItems: 'center', width: '100%' }}>
            <Col style={{ width: '100%' }} xs={24} sm={24} md={11} lg={11} xl={11}>
              <div>
                <div style={{ marginBottom: '0.5rem', }}><a style={{ color: 'black', fontWeight: '600', }}>Chi nhánh chuyển:</a> chí nhánh mặc định</div>
              </div>
            </Col>
            <Col style={{ width: '100%' }} xs={24} sm={24} md={11} lg={11} xl={11}>
              <div>
          ...
          <Row style={{ borderBottom: '1px solid rgb(236, 226, 226)', paddingBottom: '0.5rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%' }}>
            <Col style={{ width: '100%' }} xs={24} sm={24} md={11} lg={11} xl={11}>
              <div>
                <div style={{ marginBottom: '0.5rem', }}><a style={{ color: 'black', fontWeight: '600' }}>Chi nhánh nhận:</a> chi nhánh Hải Phòng</div>
              </div>
            </Col>
            <Col style={{ width: '100%' }} xs={24} sm={24} md={11} lg={11} xl={11}>
              <div>
          ...
          <div style={{ display: 'flex', marginTop: '1rem', marginBottom: '1rem', justifyContent: 'flex-start', alignItems: 'center', width: '100%', color: 'black', fontWeight: '600', fontSize: '1rem' }}>Thông tin sản phẩm</div>
          ...
          {
            selectedRowKeys && selectedRowKeys.length > 0 ? (<div style={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center', width: '100%', marginTop: '1rem' }}><Popconfirm
