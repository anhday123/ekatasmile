        ...
        <div style={{ width: '100%' }}>
          <div className={styles['employee_manager']}>
            ...
            <div className={styles['employee_manager_top']}>
              <Row
                className={styles['employee_manager_top_center']}
                gutter={20}
              >
                <Col
                ...
                >
                  <div className={styles['employee_manager_top_center_item']}>
                    ...
                    <div
                      className={styles['employee_manager_top_center_item_top']}
                    >
                      Tổng nhân sự
                    </div>
                  </div>
                ...
                >
                  <div
                    className={styles['employee_manager_top_center_item_left']}
                  >
                    <div style={{ fontSize: '1.5rem', fontWeight: '600' }}>
                      0
                    </div>
                ...
                >
                  <div
                    className={
                      styles['employee_manager_top_center_item_center']
                    }
                  >
                    <div style={{ fontSize: '1.5rem', fontWeight: '600' }}>
                      {monthSix}
