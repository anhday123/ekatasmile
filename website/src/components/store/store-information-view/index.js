  ...
  return (
    <>
      <div
        ...
        onClick={() => modal4VisibleModalInfo(true, recordData.recordData)}
      >
        {recordData.recordData.code}
      </div>
      <Modal
        ...
        >
          ...
          <Col style={{ width: '100%' }} xs={24} sm={11} md={11} lg={7} xl={7}>
            <div>
              ...
              <div>
                <b style={{ marginRight: '0.25rem' }}>Quận/huyện:</b>{' '}
                {record.district}
              </div>
              <div>
                <b style={{ marginRight: '0.25rem' }}>Thành phố: </b>{' '}
                {record.province}
              </div>
            </div>
          </Col>
          ...
          <Col style={{ width: '100%' }} xs={24} sm={11} md={11} lg={7} xl={7}>
            <div>
              ...
              <div>
                <b style={{ marginRight: '0.25rem' }}>Mã cửa hàng:</b>{' '}
                {record.code}
              </div>
              <div>
                <b style={{ marginRight: '0.25rem' }}>Ngày tạo: </b>{' '}
