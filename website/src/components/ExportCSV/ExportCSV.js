...
export const ExportCSV = ({ csvData, fileName, name }) => {
    ...
    return (
        ...
        >
            <Button icon={<FileExcelOutlined />} style={{ width: '7.5rem', display: 'flex', justifyContent: 'center', alignItems: 'center', backgroundColor: '#008816', }} type="primary">Xuất excel</Button>
        </div>
    )
}