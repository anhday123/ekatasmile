...
let getWardC = async (req, res, next) => {
    try {
        ...
        if (req.query.district_id) mongoQuery = { ...mongoQuery, district_id: parseInt(req.query.district_id) };
        if (req.query.province_id) mongoQuery = { ...mongoQuery, province_id: parseInt(req.query.province_id) };
