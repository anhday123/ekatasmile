        ...
        req.body.products.map((product) => {
            ...
            if (product.attributes) {
                product.attributes.map((attribute) => {
                    ...
                    if (_attributeInDBs[`pId${_product.product_id}-aId${String(attribute.option).toUpperCase()}`]) {
                        _attribute.create({
                            ..._attributeInDBs[
            ...
            if (product.variants) {
                product.variants.map((variant) => {
                    ...
                    if (_variantInDBs[`pId${_product.product_id}-vId${String(variant.sku).toUpperCase()}`]) {
                        _variant.create({
                            ..._variantInDBs[`pId${_product.product_id}-vId${String(variant.sku).toUpperCase()}`],
                        });
                    } else {
                        variant_id++;
                        variant['supplier'] = (() => {
