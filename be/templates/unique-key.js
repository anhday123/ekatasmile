module.exports._createUniqueKey = async (client, databaseName) => {
    try {
        ...
        await client.db(databaseName).collection('Attributes').createIndexes({ code: 1 }, { unique: true });
        ...
        await client.db(databaseName).collection('Branchs').createIndexes({ code: 1 }, { unique: true });
        ...
        await client.db(databaseName).collection('Brands').createIndexes({ code: 1 }, { unique: true });
        ...
        await client.db(databaseName).collection('Categories').createIndexes({ code: 1 }, { unique: true });
        ...
        await client.db(databaseName).collection('CustomerTypes').createIndexes({ code: 1 }, { unique: true });
        ...
        await client.db(databaseName).collection('Customers').createIndexes({ code: 1 }, { unique: true });
        await client.db(databaseName).collection('Branchs').createIndexes({ slug_name: 1 });
        await client.db(databaseName).collection('Branchs').createIndexes({ slug_ward: 1 });
        await client.db(databaseName).collection('Branchs').createIndexes({ slug_district: 1 });
        await client.db(databaseName).collection('Branchs').createIndexes({ slug_province: 1 });
        ...
        await client.db(databaseName).collection('Inventories').createIndexes({ code: 1 }, { unique: true });
        ...
        await client.db(databaseName).collection('Labels').createIndexes({ code: 1 }, { unique: true });
        ...
        await client.db(databaseName).collection('Locations').createIndexes({ code: 1 }, { unique: true });
        ...
        await client.db(databaseName).collection('Orders').createIndexes({ code: 1 }, { unique: true });
        await client.db(databaseName).collection('Orders').createIndexes({ import_order_id: 1 }, { unique: true });
        await client.db(databaseName).collection('Orders').createIndexes({ import_order_code: 1 }, { unique: true });
        await client.db(databaseName).collection('Orders').createIndexes({ status: 1 });
        await client.db(databaseName).collection('Orders').createIndexes({ slug_name: 1 });
        await client.db(databaseName).collection('Orders').createIndexes({ create_date: 1 });

        await client
            .db(databaseName)
            .collection('PaymentMethods')
            .createIndexes({ payment_method_id: 1 }, { unique: true });
        await client.db(databaseName).collection('PaymentMethods').createIndexes({ code: 1 }, { unique: true });
        ...
        await client.db(databaseName).collection('Products').createIndexes({ code: 1 }, { unique: true });
        ...
        await client.db(databaseName).collection('Roles').createIndexes({ code: 1 }, { unique: true });
        ...
        await client
            ...
            .createIndexes({ shipping_company_id: 1 }, { unique: true });
        await client.db(databaseName).collection('ShippingCompanies').createIndexes({ code: 1 }, { unique: true });
        ...
        await client.db(databaseName).collection('Suppliers').createIndexes({ code: 1 }, { unique: true });
        ...
        await client.db(databaseName).collection('Taxes').createIndexes({ code: 1 }, { unique: true });
        ...
        await client.db(databaseName).collection('Users').createIndexes({ code: 1 }, { unique: true });
        ...
        await client.db(databaseName).collection('Variants').createIndexes({ code: 1 }, { unique: true });
        ...
        await client.db(databaseName).collection('Warranties').createIndexes({ code: 1 }, { unique: true });
